export default class search_bar {
  constructor(element, main) {
    ...
    this.search_icon.src = "/frontend/img/search-solid.svg";
    ...
    this.delete_icon.src = "/frontend/img/times-solid.svg";
    ...
    this.alarm.innerHTML =
      '<div class="exclamation"><p>!</p></div> <div class="text">Please fill out the form</div>';
  ...
  render() {
    ...
    this.title.style = `margin-top: ${this.ele.offsetHeight * 0.07}px; 
                        font-size: ${Math.round(
                          this.ele.offsetWidth * 0.025
                        )}px; 
                        margin-bottom: ${this.ele.offsetHeight * 0.02}px;`;
    this.ele.appendChild(this.title);

    this.bar.style = `height: ${this.ele.offsetHeight * 0.1}px; 
                      margin-top: ${this.ele.offsetHeight * 0.05}px;`;
