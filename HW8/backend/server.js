...
import { base_req, base_req_lst, stock_history_request, stock_news_request } from "./request.js";

// {entry_point: request}
const api_list = {
  "/brief/:stock": new base_req(back_util.brief_req),
  "/summary/:stock": new base_req_lst(new base_req(back_util.summary_req), 
