...
//
//func timestampToString(_ datetime: TimeInterval, dateFormat: String = SingleNews.dateFormat) -> String {
//    let dateFormatter = DateFormatter()
//    dateFormatter.timeZone = TimeZone.current
//    dateFormatter.dateFormat = SingleNews.dateFormat
//    return dateFormatter.string(from: Date(timeIntervalSince1970: datetime))
...
//}
//
//print(SingleNews.example3().calculateTimeDiff())
...
let test = ["ticker": (data: "aaple", type: String.self), "list": (data: [1,2,3], type: Array<Int>.self)] as JSONDict

print(encodeJSON(test))
